...
public final class BehaviorRelay<T> extends Relay<T> {
    ...
    static final class BehaviorDisposable<T> implements Disposable, io.reactivex.rxjava3.internal.util.AppendOnlyLinkedArrayList.NonThrowingPredicate<T> {
